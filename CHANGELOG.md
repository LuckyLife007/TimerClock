...
### Fixed
- **Animation State Bug**: Warning and negative time animations no longer appear on clock face when display switches between timer and clock modes
- Refactored `CurrentState` from stored property to computed property to eliminate synchronization risks
